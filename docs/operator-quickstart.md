# Operator Quickstart — Community News Wire Service

Shortest path from clone to a verified local dry-run for **ISIC 6391** (`cloud-itonami-isic-6391`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6391.git
cd cloud-itonami-isic-6391
```
...
- Blueprint governor key: `wire-governor`
- Likely source path: `newswire.governor.cljc`
